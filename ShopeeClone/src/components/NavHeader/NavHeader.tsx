...
export default function NavHeader() {
  ...
  const logoutMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      setProfile(null)
      //Khi logout thi remove purchase
        ...
        renderPopover={
          <div className='relative rounded-sm border border-t-0 border-gray-200 bg-white shadow-md'>
            <div className='flex flex-col px-3 py-2'>
              <button className='px-3 py-2 pl-3 pr-28 text-left hover:text-orange' onClick={() => changeLanguage('vi')}>
                Tiếng Việt
              </button>
              <button
                className='mt-2 px-3 py-2 pl-3 pr-28 text-left hover:text-orange'
