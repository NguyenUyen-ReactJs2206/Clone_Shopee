...
/**
 * page: current page
 * pageNumber: Các page 1 2 3...19 20
 * pageSize: Tổng số page
     RANGE:  phạm vi giữa các page và dấu ...
     dotAfter: dấu chấm phía sau
 */
...
export default function Pagination({ queryConfig, pageSize }: Props) {
  ...
  return (
    <div className='flex-grap mt-6 flex justify-center'>
      {page === 1 ? (
